...
- ✅ Выявлены оптимальные комбинации позиций для NFL Single Game
...
- ✅ Выявлена корреляция между unique roster % и успехом - хорошей стратегией является максимальное количество уникальных составов в играх GPP
- ✅ Определены оптимальные значения max_exposure (около 67% для позиции капитана максимум, игрок может быть представлен в 100% составов, если предполагается, что он заработает много очков)
